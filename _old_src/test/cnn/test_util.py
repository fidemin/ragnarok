...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            np.array(
                [
                    [[[1.0, 2.0], [2.1, 3.0]], [[2.2, 2.1], [2.4, 5.0]]],
                    [[[2.1, -1.0], [-5.0, -2.2]], [[1.1, 2.1], [-1.5, 3.0]]],
                ]
            ),
            3,
            3,
    ...
    [
            ...
            np.array(
                [
                    [
                        ...
                        [
                            [1.0, 3.0, 10.0, 1.0, 2.0],
                            [2.0, 3.0, 2.0, 2.0, 1.0],
                            [0.0, 8.0, 8.0, -10.0, 4.0],
                            [1.0, 3.0, 8.0, 1.0, 2.0],
                            [2.0, 5.0, 2.0, 3.0, 6.0],
                        ],
                    ]
        ...
        (
            ...
            np.array(
                [
                    [
                        [[1.0, 4.0, 1.0], [-2.0, 12.0, 4.4], [5.0, -8.0, 2.5]],
                        [[5.0, 8.0, 1.1], [-4.0, 4.0, 4.0], [2.5, 6.0, 3.1]],
                    ],
                    [
                        [[3.0, 4.0, 3.2], [-2.0, 4.4, 10.0], [4.5, 4.8, 2.1]],
                        [[3.3, 4.6, -2.2], [6.8, 8.4, -2.2], [2.5, 13.6, 2.1]],
                    ],
                ]
            ),
        ),
        ...
        (
            ...
            np.array(
                [
                    [[[4.0, 8.0], [8.4, 12.0]], [[8.8, 8.4], [9.6, 20.0]]],
                    [[[8.4, -4.0], [-20.0, -8.8]], [[4.4, 8.4], [-6.0, 12.0]]],
                ]
            ),
        ),
    ],
...
def test_fil2col():
    ...
    expected = np.array(
        [[1.0, 2.0, 1.0, 2.0, 1.1, -1.0], [3.0, 1.0, 2.0, 4.0, -1.1, 2.0]]
    )
