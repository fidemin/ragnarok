...
from _old_src.main.core.layer import Affine
from _old_src.main.core import Net
from _old_src.main.core import Adam
from _old_src.main.language.layer import CBOWInputEmbedding, NegativeSampling
...
if __name__ == "__main__":
    ...
    layer2 = Affine.from_sizes(
        hidden_layer_size, input_layer_size, Adam(), useBias=False
    )
    ...
    # init_weight1 = 0.01
    layer2_1 = CBOWInputEmbedding.from_size(
        input_layer_size, hidden_layer_size, Adam(), init_weight=init_weight1
    )
    sampler = UnigramSampler(word_id_list, remember_sampling=True)
    negative_size = 10
    init_weight2 = 1 / np.sqrt(hidden_layer_size)
    # init_weight2 = 0.01
    layer2_2 = NegativeSampling.from_size(
        hidden_layer_size,
        input_layer_size,
        negative_size,
        sampler,
    ...
    for i in range(iter_num):
        ...
        net2.gradient_descent(
            x_batch_original, y_batch_original, kwargs_list=kwargs_list
        )
