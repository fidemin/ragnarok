...
from _old_src.main.core import layer
...
if __name__ == "__main__":
    ...
    layer1 = layer.Affine.from_sizes(
        input_size, hidden_size, updater1, init_weight=init_weight1
    )
    layer2 = layer.Relu()
    init_weight2 = 2 / np.sqrt(hidden_size)
    layer3 = layer.Affine.from_sizes(
        hidden_size, output_size, updater2, init_weight=init_weight2
    )
