...
from _old_src.main.cnn.layer import Convolution, Pooling
from _old_src.main.core.layer import Relu, Affine
...
if __name__ == "__main__":
    ...
    layer1 = Convolution.from_sizes(
        F_shape, SGD(), stride=stride, padding=padding, weight_init=init_weight1
    )
    ...
    layer4 = Affine.from_sizes(
        affine_input_size, hidden_size, SGD(), init_weight=weight_init2
    )
    ...
    layer6 = Affine.from_sizes(
        input_size=hidden_size,
        output_size=output_size,
        updater=SGD(),
        init_weight=weight_init3,
    )
