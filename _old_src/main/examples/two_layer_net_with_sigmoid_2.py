...
from _old_src.main.core.layer import Affine, Sigmoid, SoftmaxWithLoss, BatchNorm
...
if __name__ == "__main__":
    ...
    two_layer_net = NeuralNet(
        [layer1, layer2, layer3, layer4], loss_layer, Adam(lr=0.05)
    )
    ...
    for epoch in range(max_epoch):
        ...
        print(
            "epoch: {}, loss: {}, test accuracy: {}".format(
                epoch + 1, loss_list[len(loss_list) - 1], accuracy
            )
        )
