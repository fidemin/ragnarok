...
if __name__ == "__main__":
    ...
    # window_size = 5
    window_size = 2
    context_target_converter = ContextTargetConverter(
        word_id_list, window_size=window_size
    )
    ...
    # init_weight1 = 0.01
    layer1 = CBOWInputEmbedding.from_size(
    ...
    # init_weight2 = 0.01
    layer2 = NegativeSampling.from_size(
        hidden_layer_size,
        input_layer_size,
        negative_size,
        sampler,
