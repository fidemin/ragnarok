...
from _old_src.main.core.layer import Layer, SoftmaxWithLoss
from _old_src.main.core.optimizer import Optimizer
from _old_src.main.core.util import clip_grads
...
class NeuralNet:
    def __init__(
        self, layers: list[Layer], loss_layer, optimizer: Optimizer, predict_layer=None
    ):
        self._layers = layers
        self._params = []
        self._grads = []
