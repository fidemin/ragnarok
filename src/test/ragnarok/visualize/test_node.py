    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                None,
                "float32",
                '0 [label="float32", color=orange, style=filled]',
            ),
            ...
            (
                ...
                None,
                "float32",
                '0 [label="x: float32", color=orange, style=filled]',
            ),
            (
                0,
                None,
                (2, 3),
                "float32",
                '0 [label="(2, 3) float32", color=orange, style=filled]',
            ),
            (
                0,
                "x",
                (2, 3),
                "float32",
                '0 [label="x: (2, 3) float32", color=orange, style=filled]',
            ),
        ],
    )
...
class TestDotFunctionNode:
    @pytest.mark.parametrize(
        "id_, name, input_ids, output_ids, expected",
        [
            (
                0,
                "Square",
                [],
                [],
                '0 [label="Square", color=lightblue, style=filled, shape=box]',
            ),
        ],
    )
    def test_to_str(self, id_, name, input_ids, output_ids, expected):
        node = DotFunctionNode(id_, name, input_ids=input_ids, output_ids=output_ids)
        assert node.to_str() == expected

    @pytest.mark.parametrize(
        "id_, name, input_ids, output_ids, expected_list",
        [
            (
                0,
                "Square",
