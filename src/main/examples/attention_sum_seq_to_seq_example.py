...
from src.main.language.layer import GroupedSoftmaxWithLoss
from src.main.language.seq2seq import Seq2Seq, AttentionSeq2Seq
from src.main.language.util import WordIdConverter, convert_to_one_hot_encoding
...
def convert_decoder_input_to_expected_output(decoder_input: np.ndarray, max_word_id: int, one_hot=True):
